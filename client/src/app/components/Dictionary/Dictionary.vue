...
<script setup>
	import { provideDictionaries } from "../../../services/record.service";
	...
	import { defineAsyncComponent, inject, ref, onMounted, onErrorCaptured } from "vue";
	...
	async function getAllRecords() {
		try {
      const rex = await provideDictionaries();
			useArray.value = rex.data;
		} catch (err) {
			useError.value = true;
